    ...
    <tr>
        <th scope="row" style="text-align:center;">
            <a title="Más infomación" data-toggle="modal" href="#paquete1">
                <img src="img/paq1.png" alt="pestañas cobertura sup" width="70%">
            </a>
        </th>
        <td style="font-weight:bold; text-align:center;">
        ...
        <td colspan="3" rowspan="2" style="font-weight:bold; text-align:center;">
    ...
    <tr>
        <th scope="row" style="text-align:center;">
            <a title="Más infomación" data-toggle="modal" href="#paquete2">
                <img src="img/paq2.png" alt="pestañas cobertura sup" width="70%">
            </a>
        </th>
        <td style="font-weight:bold; text-align:center;">
    ...
    <tr>
        <th scope="row" style="text-align:center;">
            <a title="Más infomación" data-toggle="modal" href="#paquete3">
                <img src="img/paq3.png" alt="pestañas cobertura sup" width="70%">
            </a>
        </th>
        <td style="font-weight:bold; text-align:center;">
    ...
    <tr>
        <th scope="row" style="text-align:center;">
            <a title="Más infomación" data-toggle="modal" href="#paquete4">
                <img src="img/paq4.png" alt="pestañas cobertura sup" width="70%">
            </a>
        </th>
        <td style="font-weight:bold; text-align:center;">
        ...
        <table class="table table-striped table-condensed">
            <thead>
                <tr>
                    ...
                    <td></td>
                    <td style="text-align:center;">
                        <img src="img/cob3.png" alt="pestañas cobertura sup" style="position: relative; bottom: -4px;">
                    </td>
                </tr>
            </thead>
            <tbody>
        ...
        <table class="table table-striped table-condensed">
            <thead>
                <tr>
                    ...
                    <td></td>
                    <td style="text-align:center;">
                        <img src="img/cob4.png" alt="pestañas cobertura sup" style="position: relative; bottom: -4px;">
                    </td>
                </tr>
            </thead>
            <tbody>
