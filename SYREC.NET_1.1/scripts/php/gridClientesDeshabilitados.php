...
$result = $db->sql_query("SELECT COUNT(*) AS count FROM usuarios,relaciones WHERE idUsuario = idUsuarioHijo AND idUsuarioPadre = $idUsr AND usuarios.Status = 0");
