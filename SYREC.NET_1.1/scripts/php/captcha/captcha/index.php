<?php 
require_once('scripts/php/captcha/CaptchasDotNet.php');
$captcha = new CaptchasDotNet('SYREC', 'H7tG84ZGymYo0TCXOMbT4qW6Oxiu6boIr372Ae9g');
?>
            ...
            <table width="600" cellpadding="2" cellspacing="0" class="tbmain">
                ...
                <tr>
                    ...
                    <td class="midmid" valign="top">
                        <form accept-charset="utf-8" action="scripts/php/verifica.php" method="post" name="q_form_10960813426">
                                    ...
                                    <table width="300" cellpadding="5" cellspacing="0">
                                        ...
                                        <tr>
                                            <td width="150" class="left">
												...
												<input type="hidden" name="random" value="<?= $captcha->random () ?>" />
                                            </td>
											<td class="right">
                                        ...
                                        <tr >
                                            <td valign="top" class="left" align="center" colspan = "2">
                                                <div align="center" style="margin-left:50px;"><img src="http://www.syrec.net/scripts/php/captcha/captcha/captcha.php" /></div>
                                            </td>
                                        </tr>
                ...
                <tr>
                    ...
                    <td class="bottommid" style="text-align:center;font-family:Arial, Helvetica, sans-serif;"><strong>.::SYREC &copy;<?php echo date('Y');?>::.</strong></td>
