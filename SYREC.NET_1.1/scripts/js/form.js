...
function validate(elem,type,option){	// Main function
            ...
            if(!warned){
                ...
                for(var x =0; x< inputs.length; x++){
                    if(inputs[x].type == 'submit'){
                        ...
                        errdiv.innerHTML = 'Hay campos vacíos, por favor corrija';
	...
	var getMsg = function(type){
		switch(type){
			...
			case "RequiredNumeric":    return "Este campo es requirido y debe contener carateres numéricos."
			case "Email":              return "Ingrese una dirección de Correo Válida."
