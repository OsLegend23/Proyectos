...
$viewpage = isset($_REQUEST['page'])?  $_REQUEST['page']: 'search';
...
<html lang="en">
    ...
    <body>
        ...
        ?>
        <script type="text/javascript" src="../inc/js/jquery.carouFredSel-6.2.0-packed.js"></script>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                if (window.location.pathname == window.location.pathname){
                    $('#buscarTrabajo').addClass('current');
                }
                ...
                function consultType(consult) {
                    ...
                    if (consult == 'consult-advancedquery') {
                        $('#formrow_workArea').show();
                        $('#formrow_location').show();
                    }
                    else if (consult == 'consult-practices') {
