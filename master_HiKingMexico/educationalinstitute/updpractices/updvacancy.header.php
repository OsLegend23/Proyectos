...
if(!isset($COMMON)){echo "<body onLoad=window.setTimeout(top.location.href='../index.php',0)></body>";die();}
	...
	$gForm->setField('ICONBUTTON','AddStudyLevel','', array(), array('ICON'=>"_down_min.png", 'TITLE'=>$STR['AddToList']));
	...
	$gForm->setField('ICONBUTTON','AddLanguageLevel','', array(), array('ICON'=>"_down_min.png", 'TITLE'=>$STR['AddToList']));
	$gForm->setField('TABLE','TableLikeLanguages','', array(), array(), array());
	
	$gForm->setField('SEPARATOR','','', array(), array());
	$gForm->setField('COMMENT','',$STR['OtherStudyRequires'], array(), array());	
	$gForm->setField('TEXTAREA','OtherStudyRequires',$STR['OtherStudyRequires'], array(), array());
	...
	$gForm->setField('ICONBUTTON','AddWorkExperience','', array(), array('ICON'=>"_down_min.png", 'TITLE'=>$STR['AddToList']));		
